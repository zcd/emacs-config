...
Use =zenburn-theme= for visuals. The system-agnostic check for font
existence is lifted from [[https://emacsredux.com/blog/2021/12/22/check-if-a-font-is-available-with-emacs-lisp/][this blog post]].
  ...
  (use-package zenburn-theme
    ...
    (zenburn-with-color-variables
      ...
      (set-face-attribute 'header-line nil
                          ...
                          :height (font-settings-size-header-line me/font-config))
      (set-face-attribute 'mode-line nil
                          :box `(:line-width 1 :color ,zenburn-bg-1)
                          :foreground zenburn-bg+3
                          :height (font-settings-size-mode-line me/font-config))
